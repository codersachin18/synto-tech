...
export const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    const roadMarkings_fragment = `
      ...
      float shoulderLinesWidth = 1. * uShoulderLinesWidthPercentage;
      ...
      float lane = fract((uv.x - shoulderLinesWidth) / (1. - shoulderLinesWidth * 2.) * uLanes);
      float laneEmptySpace = 1. - uBrokenLinesLengthPercentage;
      float brokenLines = step(1. - brokenLineWidth, lane) * step(laneEmptySpace, fract(uv.y * 10.));
  ...
  return <div id="lights" ref={hyperspeed} className="w-full h-full absolute inset-0 -z-10" />;
};
